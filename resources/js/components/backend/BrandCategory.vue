      ...
      <div class="col-12 col-lg-10 col-xl-12">
        <div class="card mb-4 shadow-sm">
          <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center py-3">
            <div>
              <h5 class="card-title mb-0">Brand Category List</h5>
            </div>

            <button class="btn btn-primary" type="button" @click="openCreateFromComponent">
              <i class="ti ti-plus me-1"></i> Add Brand Category
            </button>
          </div>
          ...
          <div class="card-body">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
              ...
              <div class="d-flex gap-2 align-items-center">
                <input
                  ...
                  v-model="search"
                  @keyup.enter="getbrandcategorydata(1)"
                />
              </div>
            </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover align-middle">
                ...
                <tbody v-if="brandcategorys.length">
                  <tr v-for="(s, idx) in brandcategorys" :key="s.id">
                    <td>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap gap-2">
              ...
              <div class="d-flex align-items-center gap-2">
                <button
                  ...
                  @click="getbrandcategorydata(currentPage - 1)"
                >
                  Previous
                </button>
          ...
          <div class="xwrap">
            <div class="xbox" role="dialog" aria-modal="true">
              <div class="xhead d-flex justify-content-between align-items-center">
                <div>
                  <h5 class="mb-0">Edit Brand Category</h5>
                </div>
              ...
              <form @submit.prevent="updatebrandcategory">
                <div class="xbody">
                  <div class="row g-3">
                    <div class="col-12">
        ...
        <div v-if="del.open" class="xmask" @click.self="closeDelete">
          <div class="xwrap">
            <div class="xbox xsmall" role="dialog" aria-modal="true">
              <div class="xhead d-flex justify-content-between align-items-center">
                <h5 class="mb-0 text-danger">Delete Brand Category</h5>
...
import BrandCategoryCreateForm from "../../components/createform/BrandCategoryCreateForm.vue";

export default {
  name: "SupplierList",
  components: { BrandCategoryCreateForm },
  ...
  mounted() {
    this.getbrandcategorydata(1);
  },

  watch: {
    search() {
      clearTimeout(this._t);
      this._t = setTimeout(() => this.getbrandcategorydata(1), 300);
    },
    perPage() {
      this.getbrandcategorydata(1);
    },
  ...
  methods: {
    ...
    async getbrandcategorydata(page = 1) {
      this.loading = true;
      try {
        const res = await axios.get(`${this.url}get-brand-category`, {
          params: {
            page,
        ...
        this.brandcategorys = res.data.data || [];
        ...
        console.error(e);
        this.toast(e?.response?.data?.message || "Failed to load Brand Category list", "error");
      } finally {
        this.loading = false;
      }
    },
    ...
    async handleCreated() {
      ...
      await this.getbrandcategorydata(this.currentPage);
    },
    ...
    async updatebrandcategory() {
      ...
      try {
        ...
        const res = await axios.post(
          `${this.url}brand-category-update-data/${this.edit.form.id}`,
          fd
        );
    ...
    async confirmDelete() {
      ...
      try {
        const res = await axios.delete(
          `${this.url}brand-category-delete/${this.del.item.id}`
        );

        this.toast(res.data?.message || "Deleted successfully", "success");
        this.closeDelete();

        const willBeEmpty = this.brandcategorys.length === 1 && this.currentPage > 1;
        const page = willBeEmpty ? this.currentPage - 1 : this.currentPage;
        await this.getbrandcategorydata(page);
      } catch (e) {
        const data = e?.response?.data;
        console.error(e);
