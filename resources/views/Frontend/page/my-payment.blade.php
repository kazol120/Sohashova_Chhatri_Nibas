...
<div class="container pb-5">
  ...
  <div class="row g-4 mb-4">
    <div class="col-md-4">
      <div class="card h-100 pay-card border-top border-3 border-success">
        <div class="card-body p-4">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-egg-fried me-2 text-success"></i>Meal Overview</h5>
          ...
          <div class="row g-3 text-center mb-4">
            ...
            <div class="col-4">
              ...
              <h4 class="mb-0 fw-bold text-danger">৳{{ number_format($mealSummary->meal_cost, 0) }}</h4>
            </div>
            <div class="col-4">
              <small class="text-muted d-block mb-1">Deposit</small>
              <h4 class="mb-0 fw-bold text-success">৳{{ number_format($mealSummary->deposit_total, 0) }}</h4>
            </div>
          </div>
    ...
    <div class="col-md-8">
      <div class="card h-100 pay-card">
        <div class="card-header border-bottom p-4 d-flex align-items-center justify-content-between">
          <h5 class="mb-0 fw-bold text-dark">
            <i class="bi bi-journal-text me-2 text-primary"></i>Recent Meals (This Month)
          </h5>
        </div>
              ...
              @forelse($mealsList as $meal)
                <tr>
                  ...
                  <td class="text-center">
                    @if($meal->half_meal)
                      <span class="badge bg-info text-white">{{ $meal->note == 'day' ? '☀️ Day' : '🌙 Night' }}</span>
                    @else
