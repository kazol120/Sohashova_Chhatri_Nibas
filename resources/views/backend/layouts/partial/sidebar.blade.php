      ...
      {{-- Frontend --}}
              ...
              <li class="menu-item {{ Route::currentRouteNamed('development-fee.index') ? 'active' : '' }}">
                <a href="{{ route('development-fee.index') }}" class="menu-link fs-5">
                  <i class="fas fa-hand-holding-usd" style="background-color: white; padding: 5px; border-radius: 50%;"></i>
                  <div class="ms-3">Development Fee</div>
                </a>
              </li>
              @endrole
