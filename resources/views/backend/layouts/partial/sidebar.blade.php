      ...
      {{-- Frontend --}}
              ...
              {{-- Room --}}
              @role('admin')
              <li class="menu-item {{ Route::currentRouteNamed('room-list.index') || Request::is('room-booking-history') || Route::currentRouteNamed('room-release.index') || Route::currentRouteNamed('room-release.history') || Route::currentRouteNamed('room-change.index') || Route::currentRouteNamed('development-fee.index') ? 'active open' : '' }}">
                <a href="javascript:void(0)" class="menu-link menu-toggle fs-5">
                  <i class="fas fa-clipboard-list" style="background-color: white; padding: 5px; border-radius: 50%;"></i>
